...
<img src="images/ex0img2.png" alt="image" style="width: 500px;">


In the lower right corner of the page click button **Create Dev Space**. <br>
<img src="images/ex0img3.png" alt="image" style="max-width: 500px;">
...
Get the GitHub repository clone HTTPS URL from the repository's [landing page](https://github.com/SAP-samples/teched2025-CA263).
...
```
https://github.com/SAP-samples/teched2025-CA263.git
```
